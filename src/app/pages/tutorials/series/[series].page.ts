      ...
      <div class="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
        <article *ngFor="let tutorial of tutorials" class="flex flex-col items-start justify-between">
          <div class="relative w-full">
            <a [routerLink]="['/tutorials/series', seriesName, tutorial.slug]">
          ...
          <div class="max-w-xl">
            ...
            <div class="mt-8 flex items-center gap-x-4 text-xs">
              ...
              <a [routerLink]="['/tutorials/series', seriesName]" class="relative z-10 rounded-full bg-gray-50 px-3 py-1.5 font-medium text-primary-500 hover:bg-gray-100">{{tutorial.attributes.category}}</a>
